export default function MultiPlatformsTag(p: { containerStyle: string; iconStyle: string }) {
  return (
    <div className={p.containerStyle}>
      {/* apple */}
      <div className={p.iconStyle}>
      ...
      {/* android */}
      <div className={p.iconStyle}>
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="-147 -70 294 345">
          <g fill="#a4c639">
      ...
      {/* windows */}
      <div className={p.iconStyle}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 4875 4875" width="50" height="50">
