...
export default function TechFocusLink({ title, href, lang }: { title: string; href: string; lang: string }) {
  const t = getDictionary(lang);
  return (
    <Link target="_blank" href={href} prefetch={false} className={styles.tech_focus}>
      <svg
