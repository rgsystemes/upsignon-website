...
export default async function Article10({ params }: { params: Promise<{ lang: string }> }) {
  const { lang } = await params;
  const t = getDictionary(lang);
  return (
  ...
  return (
    <>
      ...
      <p>
        ...
        <strong>emmener tout le monde vers l’adoption des bonnes pratiques</strong> essentielles de gestion de mots de
        passe. Chez UpSignOn, nous pensons que la clé, c’est d’offrir à vos collaborateurs un outil simple qu’ils auront
        envie d’utiliser, et de vous faire remonter les informations qui vous permettront de cibler vos actions de
