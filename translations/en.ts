...
const translations: typeof fr = {
  ...
  pricing: {
    ...
    simu: {
      ...
      unitPrice: "Unit price / year excl tax",
      sumPrice: "Total price excl tax",
      sumPriceWithTaxes: "Total price incl tax",
      sumDiscounts: "Total discount excl tax",
      licences1: "Licences 1 to $to",
      licences2: "Licences $from to $to (-5%)",
      licences3: "Licences $from and beyond (-20%)",
      discount3Years: "3-year discount (-10%)",
      totalLicences: "Licences total",
      selfHostingPacakge: "Self-hosting support package",
      total: "Total",
