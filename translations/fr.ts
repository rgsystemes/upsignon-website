const translations = {
  ...
  legalNotice: {
    ...
    footer2:
      "Tous les droits de reproduction, de représentation et de mise à disposition du public sont réservés. Sauf autorisation expresse et écrite de la société SEPTEO IT SOLUTIONS.",
  },
  footer: {
    nav: {
      t: "Liens rapides",
