const translations = {
  ...
  pricing: {
    ...
    simu: {
      priceSimulator: "Simulateur",
      nbLicences: "Nombre de licences UpSignOn PRO",
      years3: "3 ans (-10%)",
      selfHosting: "Option auto-hébergement (Linux uniquement)",
      article: "Article",
      units: "Nombre d'unités",
      years: "Nombre d'années",
      unitPrice: "Prix unitaire / an",
      sumPrice: "Prix total",
      sumDiscounts: "Dont réduction",
      licences1: "Licences 1 à $to",
      licences2: "Licences $from à $to (-5%)",
      licences3: "Licences $from et au-delà (-20%)",
      discount3Years: "Réduction commande 3 ans (-10%)",
      totalLicences: "Total licences",
      selfHostingPacakge: "Forfait support auto-hébergement Linux",
      total: "Total HT",
      vat: "TVA",
      totalInclTax: "Total TTC",
      singlePayment: "Payable en une fois",
    },
    getQuote: {
      button: "Recevoir ce devis par mail",
      companyName: "Nom de l'organisation",
      companySiret: "SIRET",
      companyVAT: "N° de TVA",
      companyAddress1: "Adresse Ligne 1",
      companyAddress2: "Adresse Ligne 2",
      companyAddress3: "Adresse Ligne 3",
      contactName: "Votre prénom et nom",
      contactEmail: "Votre adresse email",
      contactPhone: "Votre numéro de téléphone",
      submit: "Recevoir le devis",
